...
local e=mvars
e.ply_checkDirectionList={}e.ply_checkRotationResult={}local function n(t,a,e)if e>=-180 and e<180 then
t[a]=e
end
end
...
n(e.ply_checkDirectionList[t],"directionX",i)n(e.ply_checkDirectionList[t],"directionY",r)n(e.ply_checkDirectionList[t],"directionRangeX",o)n(e.ply_checkDirectionList[t],"directionRangeY",a)else
return
end
end
end
...
function e._SetWeapons(l,i)if not t(l)then
return
end
local t=TppDefine.WEAPONSLOT.SUPPORT_0-1
local a,s,o,n,r
for p,l in pairs(l)do
a,t,s,o,n,r=e.GetWeaponSlotInfoFromWeaponSet(l,t)local e=TppEquip[s]if e==nil then
else
local l,p,s,c,d,m=TppEquip.GetAmmoInfo(e)if a then
vars[i][a]=e
local e,t
if o then
e=o*p
...
function e.GetWeaponSlotInfoFromWeaponSet(e,o)local r,a,n,t,i
...
local r,o,n,t,l,i=TppEquip.GetAmmoInfo(gvars.ply_lastWeaponsUsingTemp[a])e.SupplyAmmoByBulletId(r,n)gvars.initAmmoInWeapons[a]=o
e.SupplyAmmoByBulletId(t,i)gvars.initAmmoSubInWeapons[a]=l
end
end
for e=0,11 do
gvars.ply_lastWeaponsUsingTemp[e]=TppEquip.EQP_None
...
local l,n,r,i,o,t=TppEquip.GetAmmoInfo(t)e.SupplyAmmoByBulletId(l,r)gvars.initAmmoInWeapons[a]=n
e.SupplyAmmoByBulletId(i,t)gvars.initAmmoSubInWeapons[a]=o
end
function e.SupplySupportWeaponAmmoFull(a)local a,n,t,n,n,n=TppEquip.GetAmmoInfo(a)e.SupplyAmmoByBulletId(a,t)end
...
mvars.ply_intelFlagInfo=mvars.ply_intelFlagInfo or{}if o then
...
TppUI.ShowAnnounceLog(mvars.ply_gameOverCameraAnnounceLog)end
end
function e.FOBStartGameOverCamera(e,a,t)if mvars.ply_gameOverCameraGameObjectId~=nil then
return
end
mvars.ply_gameOverCameraGameObjectId=e
mvars.ply_gameOverCameraStartTimerName=a
...
function e.SetSearchTarget(l,t,s,i,a,o,r,e)if(l==nil or t==nil)then
return
end
local t=d(t)if t==n then
return
end
if r==nil then
r=true
...
local e={name=s,targetGameObjectTypeIndex=t,targetGameObjectName=l,offset=a,centerRange=.3,lookingTime=1,distance=200,doWideCheck=true,wideCheckRadius=.15,wideCheckRange=e,doDirectionCheck=false,directionCheckRange=100,doCollisionCheck=true}if(i~=nil)then
e.skeletonName=i
end
if(o~=nil)then
e.targetFox2Name=o
...
function e.PlayCommonMissionEndCamera(r,s,l,i,t,n)local a
...
function e.PlayMissionClearCameraOnRideHorse(e,p,c)local e={"SKL_004_HEAD","SKL_002_CHEST"}local a={Vector3(0,0,.05),Vector3(.15,0,0)}local t={Vector3(.1,.125,.1),Vector3(.15,.1,.05)}local n=Vector3(0,0,-3.2)local r=.2
local o
local i=false
local l=20
local s=false
...
Player.RequestToPlayCameraNonAnimation{characterId=GameObject.GetGameObjectIdByIndex("TppPlayer2",0),isFollowPos=true,isFollowRot=true,followTime=5,followDelayTime=0,candidateRots={{3,160},{3,-160}},offsetTarget=t,offsetPos=a,focalLength=28,aperture=1.875,timeToSleep=n,interpTimeAtStart=e,fitOnCamera=false,timeToStartToFitCamera=1,fitCameraInterpTime=.3,diffFocalLengthToReFitCamera=16,callSeOfCameraInterp=o,useLastSelectedIndex=r}return i
end
function e.PlayMissionClearCameraOnRideCommonArmoredVehicle(a,l,e,s)local t=Vector3(.05,-.5,-2.2)if e==1 then
...
function e.PlayMissionClearCameraOnRideTank(e,i,l)local e=Vector3(0,0,-6.5)local a=.2
local r
local t=false
local o=20
local n=false
...
Player.RequestToPlayCameraNonAnimation{characterId=GameObject.GetGameObjectIdByIndex("TppPlayer2",0),isFollowPos=true,isFollowRot=true,followTime=5,followDelayTime=0,candidateRots={{9,165},{9,-165}},offsetTarget=Vector3(0,-.85,3.25),offsetPos=e,focalLength=28,aperture=1.875,timeToSleep=o,interpTimeAtStart=a,fitOnCamera=false,timeToStartToFitCamera=1,fitCameraInterpTime=.3,diffFocalLengthToReFitCamera=16,callSeOfCameraInterp=t,useLastSelectedIndex=n}return r
end
function e.PlayMissionClearCameraOnWalkerGear(a,s,p)local n=Vector3(0,.55,.35)local t=Vector3(0,0,-3.65)local a=.2
local l
local i=false
local o=20
local r=false
...
Player.RequestToPlayCameraNonAnimation{characterId=GameObject.GetGameObjectIdByIndex("TppPlayer2",0),isFollowPos=true,isFollowRot=true,followTime=3,followDelayTime=.1,candidateRots={{7,165},{7,-165}},offsetTarget=n,offsetPos=t,focalLength=28,aperture=1.875,timeToSleep=o,interpTimeAtStart=a,fitOnCamera=false,timeToStartToFitCamera=1,fitCameraInterpTime=.3,diffFocalLengthToReFitCamera=16,callSeOfCameraInterp=i,useLastSelectedIndex=r}return l
end
...
local e={"SKL_004_HEAD","SKL_002_CHEST"}local a={Vector3(0,.1,0),Vector3(0,-.05,0)}local t={Vector3(.1,.125,.1),Vector3(.15,.1,.05)}local r=Vector3(0,0,-4.5)local n=.3
local o
local i=false
if l==1 then
...
Player.RequestToPlayCameraNonAnimation{characterId=GameObject.GetGameObjectIdByIndex("TppPlayer2",0),isFollowPos=true,isFollowRot=true,followTime=4,followDelayTime=.1,candidateRots={{-10,170},{-10,-170}},skeletonNames=e,skeletonCenterOffsets=a,skeletonBoundings=t,offsetPos=r,focalLength=28,aperture=1.875,timeToSleep=20,interpTimeAtStart=n,fitOnCamera=false,timeToStartToFitCamera=1,fitCameraInterpTime=.3,diffFocalLengthToReFitCamera=16,callSeOfCameraInterp=i}return o
end
...
mvars.ply_locationStationTable={}mvars.ply_stationLocatorList={}TppEffectUtility.SetSandWindEnable(false)end
...
function e.OnMessage(a,t,n,o,l,i,r)Tpp.DoMessage(e.messageExecTable,TppMission.CheckMessageOption,a,t,n,o,l,i,r)end
function e.Update()e.UpdateDeliveryWarp()end
local a={[TppDefine.WEATHER.SUNNY]=0,[TppDefine.WEATHER.CLOUDY]=-10,[TppDefine.WEATHER.RAINY]=-30,[TppDefine.WEATHER.FOGGY]=-50,[TppDefine.WEATHER.SANDSTORM]=-70}function e.MakeFultonRecoverSucceedRatio(a,e,a,a,a,a)Player.SetFultonIconPercentage{percentage=100,targetId=e}end
...
function e.OnPickUpCollection(o,t,a,i)local o=255
TppCollection.RepopCountOperation("SetAt",t,o)TppTerminal.AddPickedUpResourceToTempBuffer(a,i)local o={[TppCollection.TYPE_POSTER_SOL_AFGN]="key_poster_3500",[TppCollection.TYPE_POSTER_SOL_MAFR]="key_poster_3501",[TppCollection.TYPE_POSTER_GRAVURE_V]="key_poster_3502",[TppCollection.TYPE_POSTER_GRAVURE_H]="key_poster_3503",[TppCollection.TYPE_POSTER_MOE_V]="key_poster_3504",[TppCollection.TYPE_POSTER_MOE_H]="key_poster_3505"}local o=o[a]if o~=nil then
TppUI.ShowAnnounceLog("getPoster",o,TppTerminal.GMP_POSTER)end
local o
...
TppUI.ShowAnnounceLog("find_processed_res",i,o)end
...
o("Timer_DeliveryWarpSoundCannotCancel",a)local a={type="TppPlayer2",index=0}local e={id="WarpToStation",stationId=mvars.ply_selectedCboxDeliveryUniqueId}GameObject.SendCommand(a,e)end
...
mvars.ply_deliveryWarpState=nil
mvars.ply_deliveryWarpSoundCannotCancel=nil
m"Timer_DeliveryWarpSoundCannotCancel"Player.ResetPadMask{settingName="CboxDelivery"}end
...
function e.EvaluateAllCaptureCage()if mvars.loc_locationAnimalSettingTable==nil then
return
end
if CaptureCage~=nil then
e.SaveCaptureAnimal()e.AggregateCaptureAnimal()else
local n=TppPlaced.GetCaptureCageInfo()local a=0
local t=0
for r,n in pairs(n)do
local n,e,r,r=e.EvaluateCaptureCage(n.x,n.z,n.grade)if e~=0 then
TppMotherBaseManagement.DirectAddDataBaseAnimal{dataBaseId=e,areaName=n,isNew=true}local r,n=TppMotherBaseManagement.GetAnimalHeroicPointAndGmp{dataBaseId=e}a=a+r
t=t+n
TppUiCommand.ShowBonusPopupAnimal(e,"regist")end
end
if a>0 or t>0 then
TppMotherBaseManagement.AddHeroicPointAndGmpByCageAnimal{heroicPoint=a,gmp=t}end
...
if a>0 or e>0 then
TppMotherBaseManagement.AddHeroicPointAndGmpByCageAnimal{heroicPoint=a,gmp=e}end
end
function e.CheckCaptureCage(a,r)if mvars.loc_locationAnimalSettingTable==nil then
return
end
if a<2 or a>4 then
return
...
for r=1,o do
if a==2 then
Player.DEBUG_PlaceAround{radius=5,count=n,equipId=TppEquip.EQP_SWP_CaptureCage}elseif a==3 then
Player.DEBUG_PlaceAround{radius=5,count=n,equipId=TppEquip.EQP_SWP_CaptureCage_G01}elseif a==4 then
Player.DEBUG_PlaceAround{radius=5,count=n,equipId=TppEquip.EQP_SWP_CaptureCage_G02}end
for e=1,n do
coroutine.yield()end
...
function e._CheckRotation(e,a,n,o,t)local t=mvars
local t=vars.playerCameraRotation[0]local r=vars.playerCameraRotation[1]local e=foxmath.DegreeToRadian(t-e)e=foxmath.NormalizeRadian(e)local t=foxmath.RadianToDegree(e)local e=foxmath.DegreeToRadian(r-n)e=foxmath.NormalizeRadian(e)local e=foxmath.RadianToDegree(e)if(foxmath.Absf(t)<a)and(foxmath.Absf(e)<o)then
return true
else
return false
end
...
function e.EvaluateCaptureCage(a,o,i,p)local t=mvars
...
local a=0
if i==2 then
a=n(e.CageRandomTableG3)elseif i==1 then
