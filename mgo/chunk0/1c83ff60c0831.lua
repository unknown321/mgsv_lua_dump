local e={}e.PROCESS_STATE=Tpp.Enum{"EMPTY","START","SHOW_DIALOG","SUSPEND","FINISH"}e.TYPE=Tpp.Enum{"INVITATION_ACCEPT","DISCONNECT_FROM_PSN","DISCONNECT_FROM_KONAMI","DISCONNECT_FROM_NETWORK","SESSION_DISCONNECT_FROM_HOST","SIGNIN_USER_CHANGED","USER_NOT_SIGNED_IN"}e.GAME_MODE=Tpp.Enum{"TPP","TPP_FOB","MGO"}e.OnEndExceptionDialog={}e.SHOW_EXECPTION_DIALOG={[e.TYPE.INVITATION_ACCEPT]=function()return nil
...
end,[e.TYPE.USER_NOT_SIGNED_IN]=function()return TppDefine.ERROR_ID.START_NOT_SIGN_IN
...
local n=e.GetCurrentGameMode()if n==e.GAME_MODE.TPP then
e.EnablePause()end
end
...
local n=e.GetCurrentGameMode()e.DisablePause()end
function e.EnablePause()TppGameStatus.Set("TppException","S_DISABLE_PLAYER_PAD")end
function e.DisablePause()TppGameStatus.Reset("TppException","S_DISABLE_PLAYER_PAD")end
...
gvars.exc_processState=n()if gvars.exc_processState==e.PROCESS_STATE.FINISH then
e.FinishProcess()end
end
else
local n,t=e.Dequeue()e.StartProcess(n,t)do
local t=e.ShowPopup(n)if((((n==e.TYPE.DISCONNECT_FROM_PSN or n==e.TYPE.DISCONNECT_FROM_KONAMI)or n==e.TYPE.DISCONNECT_FROM_NETWORK)or n==e.TYPE.SESSION_DISCONNECT_FROM_HOST)or n==e.TYPE.SIGNIN_USER_CHANGED)or n==e.TYPE.USER_NOT_SIGNED_IN then
...
function e.Messages()return Tpp.StrCode32Table{Network={{msg="InvitationAccept",func=e.OnInvitationAccept},{msg="DisconnectFromPsn",func=e.OnDisconnectFromPsn},{msg="DisconnectFromKonami",func=e.OnDisconnectFromKonami},{msg="DisconnectFromNetwork",func=e.OnDisconnectFromNetwork},{msg="SignInUserChanged",func=e.SignInUserChanged},{msg="UserNotSignedIn",func=e.UserNotSignedIn}},Nt={{msg="SessionDisconnectFromHost",func=e.OnSessionDisconnectFromHost},{msg="SessionDeleteMember",func=function()if TppServerManager.FobIsSneak()then
local e=4181
TppUiCommand.ShowErrorPopup(e)end
end}},Dlc={{msg="DlcStatusChanged",func=e.OnDlcStatusChanged}},UI={{msg="StartDlcAnnounce",func=e.OnStartDlcAnnounce},{msg="EndDlcAnnounce",func=e.OnEndDlcAnnounce}}}end
...
function e.UserNotSignedIn()local n=e.GetCurrentGameMode()e.Enqueue(e.TYPE.USER_NOT_SIGNED_IN,n)e.Update()end
function e.OnDlcStatusChanged()gvars.isChangeDlcStatus=true
end
function e.OnStartDlcAnnounce()Player.SetPadMask{settingName="DlcAnnounce",except=false,buttons=PlayerPad.MB_DEVICE}gvars.isChangeDlcStatus=false
end
function e.OnEndDlcAnnounce(e)if e==0 then
gvars.isChangeDlcStatus=true
end
Player.ResetPadMask{settingName="DlcAnnounce"}end
local n={}function n.Update()e.Update()end
function n:OnMessage(i,t,o,r,n,E)local a
Tpp.DoMessage(e.messageExecTable,TppMission.CheckMessageOptionWhileLoading,i,t,o,r,n,E,a)end
