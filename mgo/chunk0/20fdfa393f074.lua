...
e.requires={"/Assets/mgo/script/tpplib/TppDefine.lua","/Assets/mgo/script/tpplib/TppDebug.lua","/Assets/mgo/script/tpplib/TppMath.lua","/Assets/mgo/script/tpplib/TppGVars.lua","/Assets/mgo/script/tpplib/TppSave.lua","/Assets/mgo/script/tpplib/TppMain.lua","/Assets/mgo/script/tpplib/TppTrap.lua","/Assets/mgo/script/tpplib/TppClock.lua","/Assets/mgo/script/tpplib/TppWeather.lua","/Assets/mgo/script/tpplib/TppPlayer.lua","/Assets/mgo/script/tpplib/TppDemo.lua","/Assets/mgo/script/tpplib/TppMission.lua","/Assets/mgo/script/tpplib/TppSequence.lua","/Assets/mgo/script/tpplib/TppPackList.lua","/Assets/mgo/script/tpplib/TppVarInit.lua","/Assets/mgo/script/tpplib/TppSound.lua","/Assets/mgo/script/tpplib/TppUI.lua","/Assets/mgo/script/tpplib/TppRadio.lua","/Assets/mgo/script/tpplib/TppTerminal.lua","/Assets/mgo/script/tpplib/TppException.lua"}function e.IsTypeFunc(e)return t(e)=="function"end
local p=e.IsTypeFunc
function e.IsTypeTable(e)return t(e)=="table"end
local o=e.IsTypeTable
...
function e.BfsPairs(l)local a,t,r={l},1,1
local function i(n,e)local e,n=e,nil
while true do
e,n=next(a[t],e)if o(n)then
r=r+1
a[r]=n
end
if e then
...
local n={}local T=a"msg"local f=a"func"local s=a"sender"local E=a"option"for e,r in pairs(e)do
n[e]=n[e]or{}for r,l in pairs(r)do
local r,c,u,d=r,nil,nil,nil
if p(l)then
u=l
elseif o(l)and p(l[f])then
r=a(l[T])local n={}if(t(l[s])=="string")or(t(l[s])=="number")then
n[1]=l[s]elseif o(l[s])then
n=l[s]end
c={}for r,n in pairs(n)do
if t(n)=="string"then
if e==a"GameObject"then
c[r]=I(n)if msgSndr==i then
end
else
c[r]=a(n)end
...
u=l[f]d=l[E]end
if u then
n[e][r]=n[e][r]or{}if next(c)~=nil then
...
function e.DoMessage(n,o,i,a,t,r,l,d,c)if not n then
return
end
...
local a=true
e.DoMessageAct(n,o,t,r,l,d,c,a)end
function e.DoMessageAct(n,o,e,l,r,a,t)if n.func then
if o(n.option)then
n.func(e,l,r,a)end
end
local t=n.sender
...
function e.SetGameStatus(n)if not o(n)then
return
end
local t=n.enable
...
function e.IsCommandPost(e)return n(e,A)end
...
local e=s(e)return TppDefine.HOSTAGE_GM_TYPE[e]end
function e.IsVolgin(e)return n(e,g)end
function e.IsHelicopter(e)return n(e,_)end
function e.IsEnemyHelicopter(e)return n(e,m)end
function e.IsHorse(e)return n(e,h)end
function e.IsVehicle(e)return n(e,G)end
function e.IsPlayerWalkerGear(e)return n(e,O)end
function e.IsEnemyWalkerGear(e)return n(e,B)end
...
local e=s(e)return TppDefine.FULTONABLE_GIMMICK_TYPE[e]end
...
local e=s(e)return TppDefine.BUDDY_GM_TYPE_TO_BUDDY_TYPE[e]end
...
local e=s(e)return TppDefine.ANIMAL_GAMEOBJECT_TYPE[e]end
function e.IsBossQuiet(e)return n(e,M)end
function e.IsParasiteSquad(e)return n(e,D)end
function e.IsSecurityCamera(e)return n(e,C)end
function e.IsGunCamera(e)if e==i then
return false
end
local t={id="IsGunCamera"}local n=false
n=GameObject.SendCommand(e,t)return n
end
function e.IsUAV(e)return n(e,P)end
...
function e.CheckBlockArea(e,n,t)local a,l,r,e=e[1],e[2],e[3],e[4]if(((n>=a)and(n<=r))and(t>=l))and(t<=e)then
return true
end
return false
end
function e.FillBlockArea(n,e,a,l,r,t)for e=e,l do
n[e]=n[e]or{}for r=a,r do
n[e][r]=t
end
end
end
...
local e,l=StageBlock.GetCurrentMinimumSmallBlockIndex()local a=e+r
local r=e+r
