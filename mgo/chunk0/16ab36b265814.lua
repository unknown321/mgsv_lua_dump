...
e.SFXList={RadioStart="Play_sfx_s_codec_NPC_begin",RadioEnd="Play_sfx_s_codec_NPC_end"}e.PRESET_DELAY_TIME={short=.5,mid=1.5,long=3}function e.Play(r,a)local a=a or{}local t=a.radioType or"realtime"local d=a.isEnqueue
local n=a.delayTime
local _=a.noiseType or"both"local p=a.priority
local o=a.playDebug
local l=a.isOverwriteProtectionForSamePrio
if i(n)then
...
e.PlayCommon(r,t,d,l,n,_,p,o)end
...
function e.EnableCommonOptionalRadio(e)end
...
function e.PlayCommon(a,i,d,r,n,o,i,p)local t=mvars
if not t.rad_radioPlayOnceList then
return
end
local a,i=e.GetRadioNameAndRadioIDs(a)if t.rad_radioPlayOnceList[a]then
...
if d then
TppRadioCommand.PlayDirectGroupTableEnqueue{tableName=a,groupName=i,preDelayTime=n,noiseType=o,isOverwriteProtectionForSamePrio=r}else
TppRadioCommand.PlayDirectGroupTable{tableName=a,groupName=i,preDelayTime=n,noiseType=o,isOverwriteProtectionForSamePrio=r}end
end
...
if a then
d("debugRadioStartTimer",a)else
e._PlayDebugStart()end
end
function e.PlayCommonRadio(r,o)if not _(r)then
return
end
...
mvars.rad_radioList={}mvars.rad_debugRadioLineTable={}mvars.rad_optionalRadioList={}mvars.rad_intelRadioList={}mvars.rad_gameOverRadioTable={}mvars.rad_commonRadioTable={}mvars.rad_commonRadioDelayTable={}for a,e in pairs(e.COMMON_GAME_OVER_RADIO_LIST)do
mvars.rad_gameOverRadioTable[a]=e
end
for a,e in pairs(e.COMMON_RADIO_LIST)do
mvars.rad_commonRadioTable[a]=e
end
...
function e.Init()e.messageExecTable=Tpp.MakeMessageExecTable(e.Messages())if mvars.rad_intelRadioList then
...
function e.CommonMakeRadioList(e)local d={}local t={}for r,e in pairs(e)do
...
function e.RegisterRadioList(o)for i,n in pairs(o)do
if a(n)then
mvars.rad_radioList[i]={}for r,e in pairs(n)do
local n=type(r)if n=="number"then
mvars.rad_radioList[i]=e
elseif n=="string"and a(e)then
mvars.rad_debugRadioLineTable[r]=e
end
end
else
mvars.rad_radioList[i]=n
end
end
...
if(i(e)or a(e))or p(e)then
mvars.rad_commonRadioTable[n]=e
end
end
end
function e.OnMessage(r,t,o,d,a,n,i)Tpp.DoMessage(e.messageExecTable,TppMission.CheckMessageOption,r,t,o,d,a,n,i)end
function e.PlayGameOverRadio()local n
local a
if svars.mis_gameOverRadio>0 and TppDefine.GAME_OVER_RADIO.MAX then
a=svars.mis_gameOverRadio
end
if a==nil then
a=TppDefine.GAME_OVER_RADIO.OTHERS
end
n=mvars.rad_gameOverRadioTable[a]if n==nil then
n=mvars.rad_gameOverRadioTable[TppDefine.GAME_OVER_RADIO.OTHERS]end
SubtitlesCommand.SetIsEnabledUiPrioStrong(true)e.Play(n,{noiseType="none"})end
...
d("debugRadioTimer",n+e)if a.rad_debugRadioGroupLine==1 then
if WaveControl then
