...
local c={}local u=0
local n={}local n=0
local d={}local m={}local r=0
local S={}local h={}local o=0
...
l(o,_G[e].DeclareSVars(n))end
end
end
local s={}for n,e in pairs(n)do
if i(e.DeclareSVars)then
l(s,e.DeclareSVars())end
if t(e.saveVarsList)then
l(s,TppSequence.MakeSVarsTable(e.saveVarsList))end
end
l(o,s)TppScriptVars.DeclareSVars(o)TppScriptVars.SetSVarsNotificationEnabled(false)while M()do
coroutine.yield()end
...
function e.OnEnterMissionPrepare()end
...
TppWeather.OnMissionCanStart()TppMission.OnMissionStart()if mvars.loc_locationCommonTable then
...
n[e]()end
P()end
function e.OnChangeSVars(e,t,n)for i,e in ipairs(Tpp._requireList)do
if _G[e].OnChangeSVars then
_G[e].OnChangeSVars(t,n)end
end
end
...
function e.OnMessage(e,n,t,i,a,p,l)local e=mvars
local s=""local T
...
for e=1,r do
local o=s
d[e](n,t,i,a,p,l,o)end
for e=1,o do
local o=s
c(S[e],u,n,t,i,a,p,l,o)end
if e.loc_locationCommonTable then
e.loc_locationCommonTable.OnMessage(n,t,i,a,p,l,s)end
if e.order_box_script then
e.order_box_script.OnMessage(n,t,i,a,p,l,s)end
if e.animalBlockScript and e.animalBlockScript.OnMessage then
e.animalBlockScript.OnMessage(n,t,i,a,p,l,s)end
end
