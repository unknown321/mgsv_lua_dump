...
local e={[10010]=true,[10030]=true,[10240]=true,[10280]=true,[30050]=true,[30150]=true,[30250]=true}if e[vars.missionCode]then
return
end
...
local e={missionId=vars.missionCode,clearTimeMinute=t,killCount=e}if(vars.missionCode~=30010)and(vars.missionCode~=30020)then
...
function e.AcquireDlcItemEmblem()local t={EMBLEM_FRONT_VENOM_SNAKE="front85"}local function n(t,e)return TppEmblem.Add(e)end
for t,a in pairs(t)do
local t=DlcItem[t]if t then
e.AcquireDlcItem(t,n,a)end
end
end
...
local n={[t.STAFF_UNIQUE_TYPE_ID_OCELOT]=TppDefine.STORY_SEQUENCE.CLEARD_TO_MATHER_BASE,[t.STAFF_UNIQUE_TYPE_ID_MILLER]=TppDefine.STORY_SEQUENCE.CLEARD_TO_MATHER_BASE,[t.STAFF_UNIQUE_TYPE_ID_HEUY]=TppDefine.STORY_SEQUENCE.CLEARD_RESCUE_HUEY,[t.STAFF_UNIQUE_TYPE_ID_CODE_TALKER]=TppDefine.STORY_SEQUENCE.CLEARD_METALLIC_ARCHAEA}function e.AddUniqueCharactor()local e=TppStory.GetCurrentStorySequence()for n,t in pairs(n)do
if t<=e then
local e=TppMotherBaseManagement.GenerateStaffParameter{staffType="Unique",uniqueTypeId=n}if not TppMotherBaseManagement.IsExistStaff{staffId=e}then
TppMotherBaseManagement.DirectAddStaff{staffId=e}end
end
end
end
function e.GetFobStatus()if TppServerManager.GetFobStatus then
...
function e.DeclareSVars()return{{name="trm_missionFultonCount",type=TppScriptVars.TYPE_UINT32,value=0,save=true,sync=false,wait=false,category=TppScriptVars.CATEGORY_MB_MANAGEMENT},{name="trm_isBuddyRecovered",type=TppScriptVars.TYPE_BOOL,arraySize=o,value=false,save=true,sync=false,wait=false,category=TppScriptVars.CATEGORY_MB_MANAGEMENT},nil}end
function e.Messages()local a=TppEnemy.GetCpIntelTrapTable()local n
if a and next(a)then
n={}for t,a in pairs(a)do
local r={msg="Enter",sender=a,func=function(n,n)e.OnEnterCpIntelTrap(t)if TppSequence.IsMissionPrepareFinished()then
e.ShowLocationAndBaseTelop()end
end,option={isExecMissionPrepare=true}}table.insert(n,r)local e={msg="Exit",sender=a,func=function(n,n)e.OnExitCpIntelTrap(t)end,option={isExecMissionPrepare=true}}table.insert(n,e)end
...
return Tpp.StrCode32Table{GameObject={{msg="Fulton",func=function(e,t,n,a)mvars.trm_fultonInfo=mvars.trm_fultonInfo or{}mvars.trm_fultonInfo[e]={e,t,n,a}end,option={isExecMissionClear=true,isExecDemoPlaying=true}},{msg="FultonInfo",func=function(n,a)mvars.trm_fultonInfo=mvars.trm_fultonInfo or{}local t=mvars.trm_fultonInfo[n]if t then
...
end}},Terminal={{msg="MbDvcActCallBuddy",func=function(e,t)TppUI.SetSupportCallBuddyType(e)TppUI.ShowCallSupportBuddyAnnounceLog()end}},Trap=n,Network={{msg="NoticeSneakMotherBase",func=function(n,e)local t
if e==0 then
t="tpp_fob_name1"elseif e==1 then
t="tpp_fob_name2"elseif e==2 then
t="tpp_fob_name3"elseif e==3 then
t="tpp_fob_name4"else
t="tpp_fob_name1"end
local a={[10010]=true,[10030]=true,[10115]=true,[10150]=true,[10151]=true,[10260]=true,[10280]=true,[11151]=true,[50050]=true}if a[vars.missionCode]then
else
local a=true
if n==FobMode.MODE_ACTUAL then
TppMotherBaseManagement.SetMyFobEmergency{emergency=true}TppUI.ShowAnnounceLog("fobNoticeIntruder",t)TppUI.ShowEmergencyAnnounceLog(a)TppUiCommand.ShowSideFobInfo("start",TppUI.ANNOUNCE_LOG_TYPE.fobNoticeIntruder)elseif n==FobMode.MODE_SHAM then
TppMotherBaseManagement.SetMyFobEmergency{emergency=true}TppUI.ShowAnnounceLog"fobReqPractice"TppUI.ShowEmergencyAnnounceLog(a)TppUiCommand.ShowSideFobInfo("start",TppUI.ANNOUNCE_LOG_TYPE.fobReqPractice)elseif n==FobMode.MODE_VISIT then
if e==0 then
TppUI.ShowAnnounceLog"fobVisitFob1"elseif e==1 then
TppUI.ShowAnnounceLog"fobVisitFob2"elseif e==2 then
TppUI.ShowAnnounceLog"fobVisitFob3"elseif e==3 then
TppUI.ShowAnnounceLog"fobVisitFob4"else
TppUI.ShowAnnounceLog"fobVisitFob1"end
end
end
end}}}end
function e.OnMessage(t,n,r,a,_,M,o)Tpp.DoMessage(e.messageExecTable,TppMission.CheckMessageOption,t,n,r,a,_,M,o)end
...
function e.DoFuncByFultonTypeSwitch(e,t,r,n,o,a,d,p,S,c,T,s,u,M,_,i,E)if Tpp.IsSoldier(e)then
return d(e,t,r,n,o,a)elseif Tpp.IsVolgin(e)then
return p(e)elseif Tpp.IsHostage(e)then
return S(e,t,r,n,o,a)elseif Tpp.IsVehicle(e)then
return c(e,t,r,n,nil,a)elseif Tpp.IsFultonContainer(e)then
return T(e,t,r,n,nil,a)elseif Tpp.IsFultonableGimmick(e)then
return s(e,t,r,n,nil,a)elseif Tpp.IsEnemyWalkerGear(e)then
return M(e,t,r,n,nil,a)elseif Tpp.IsAnimal(e)then
return _(e,t,r,n,nil,a)elseif Tpp.IsBossQuiet(e)then
return i(e,t,r,n,o,a)elseif Tpp.IsParasiteSquad(e)then
return E(e,t,r,n,nil,a)else
local o=Tpp.GetBuddyTypeFromGameObjectId(e)if o then
return u(e,t,r,n,o,a)end
end
end
function e.OnFulton(t,n,a,o,r,M,_)if M then
mvars.trm_needHeliSoundOnAddStaffsFromTempBuffer=true
end
TppEnemy.SetRecovered(t)TppEnemy.ExecuteOnRecoveredCallback(t,n,a,o,r,M,_)e.DoFuncByFultonTypeSwitch(t,n,a,o,r,_,e.OnFultonSoldier,e.OnFultonVolgin,e.OnFultonHostage,e.OnFultonVehicle,e.OnFultonContainer,e.OnFultonGimmickCommon,e.OnFultonBuddy,e.OnFultonEnemyWalkerGear,e.OnFultonAnimal,e.OnFultonBossQuiet,e.OnFultonParasiteSquad)end
...
local _=TppMotherBaseManagement.GetTempStaffStatusFromGameObject{gameObjectId=t}local a
if r then
a=r
else
...
e.AddTempStaffFulton{staffId=a,gameObjectId=t,tempStaffStatus=_,fultonedPlayer=o}end
function e.OnFultonVolgin(e)if mvars.trm_isSkipAddResourceToTempBuffer then
return
end
TppMotherBaseManagement.AddTempCorpse()end
function e.OnFultonHostage(t,n,n,o,a,r)local _=TppMotherBaseManagement.GetTempStaffStatusFromGameObject{gameObjectId=t}local n
if o then
n=o
else
...
e.AddTempStaffFulton{staffId=n,gameObjectId=t,tempStaffStatus=_,fultonedPlayer=r}end
...
e.GIMMICK_RESOURCE_ID_TABLE={[1845465265]=t.RESOURCE_ID_EMPLACEMENT_GUN_EAST,[2207998916]=t.RESOURCE_ID_EMPLACEMENT_GUN_WEST,[1187982616]=t.RESOURCE_ID_MORTAR_NORMAL,[3601635493]=t.RESOURCE_ID_ANTI_AIR_GATLING_GUN_EAST,[20562949]=t.RESOURCE_ID_ANTI_AIR_GATLING_GUN_WEST}function e.OnFultonGimmickCommon(a,a,a,n,a,t)if mvars.trm_isSkipAddResourceToTempBuffer then
return
end
local a=e.GIMMICK_RESOURCE_ID_TABLE[n]if a then
e.AddTempResource(a,nil,t)else
e.AddTempResource(n,nil,t)end
end
...
function e.AddTempResource(n,t,a)local a=a or 0
if not e.CheckAddTempBuffer(a)then
return
end
local e=t or 1
TppMotherBaseManagement.AddTempResource{resourceId=n,count=e}end
...
function e.ShowLocationAndBaseTelop()TppUiCommand.RegistInfoTypingText("location",1)local e=e.GetLocationAndBaseTelop()if e then
...
function e._AddUniqueVolunteerStaff(n,e)if TppMotherBaseManagement.IsExistStaff{uniqueTypeId=n}then
return
end
local t=false
if e~=nil then
...
local n=TppMotherBaseManagement.GenerateStaffParameter{staffType="Unique",uniqueTypeId=n}TppMotherBaseManagement.DirectAddStaff{staffId=n,section="Wait",isNew=true,specialContract=t}TppUiCommand.ShowBonusPopupStaff(n,e)return true
end
...
e.RewardLangIdTable={Combat={"reward_105","reward_106"},BaseDev={"reward_100","reward_101"},Spy={"reward_102"},Medical={"reward_103"},Security={"reward_108"},Hospital={"reward_104"}}function e.PushRewardOnMbSectionOpen()for t,a in ipairs(e.MOTHER_BASE_SECTION_LIST)do
local n=e.RewardLangIdTable[a]local e=e.IsReleaseSection(a)if e~=nil and n then
if e then
...
function e.PlayTerminalVoice(n,e,t)if mvars.trm_voiceDisabled and e~=false then
return
end
TppUiCommand.RequestMbSoundControllerVoice(n,e,t)end
function e.OnFultonFailedEnd(e,e,e,e)TppUI.ShowAnnounceLog"extractionFailed"end
