...
local i=TppSystemUtility.GetCurrentGameMode()FoxFadeIo.FadeOut(0)TppUiStatusManager.SetStatus("PauseMenu","INVALID")TppUiCommand.SetLoadIndicatorVisible(true)local e=false
if i=="MGO"then
e=TppSystemUtility.GetIsBeta()end
if((i~="MGO"or e)and TppGameSequence.GetTargetArea()=="Japan")and not SignIn.PresetUserIdExists()then
...
Script.LoadLibrary"Tpp/Scripts/System/Block/Overflow.lua"end
...
if TppSystemUtility.GetCurrentGameMode()~="MGO"then
NavTactical.SetTacticalActionSystemScript"/Assets/tpp/editor_scripts/fox/tactical_action/TppTacticalActionSystem.lua"end
local a=true
...
if i=="MGO"then
GrTools:SetLodFactorResolution(1120)end
...
TppGameSequence.SetSystemBlockSize(e,(40.5*1024)*1024)if TppSystemUtility.GetCurrentGameMode()=="MGO"then
TppGameSequence.LoadResidentBlock"/Assets/mgo/pack/resident/resident00.fpk"else
TppGameSequence.LoadResidentBlock"/Assets/tpp/pack/resident/resident00.fpk"end
if TppSystemUtility.GetCurrentGameMode()~="MGO"then
...
Player.CreateResidentMotionBlock{size=12068883}if a=="Xbox360"or a=="PS3"then
Player.CreateResidentPartsBlock{count=6,size=1126*1024}else
Player.CreateResidentPartsBlock{count=16,size=1536*1024}end
...
if TppSystemUtility.GetCurrentGameMode()=="MGO"then
TppEquip.CreateResidentBlockGroups{commonBlockSize=(10*1024)*1024}TppEquip.LoadCommonBlock"/Assets/mgo/pack/collectible/common/col_common_mgo.fpk"else
...
TppMarker2System.CreateMarker2System()if TppSystemUtility.GetCurrentGameMode()=="MGO"then
WorldMarker.CreateMarkerControl()end
local e=false
...
t()end
local e=o.."level_asset/weapon/ParameterTables/parts/EquipParameters.lua"if TppEquip.IsExistFile(e)then
Script.LoadLibrary(e)else
Script.LoadLibrary"Tpp/Scripts/Equip/EquipParameters.lua"end
t()local e=o.."level_asset/weapon/ParameterTables/parts/EquipMotionDataForChimera.lua"if TppEquip.IsExistFile(e)then
...
Script.LoadLibrary"/Assets/mgo/ui/Script/BriefingScript.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModAppealActionEdit.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModCharacterEdit.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModCharacterSelect.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModClassEdit.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModColorNavigation.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModColorPallet.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModControls.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModGearEdit.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModGearOverview.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModGenderEdit.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModInfo.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModLoadoutSelect.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModNavigation_New.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModWeaponEditAttach.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModWeaponEditPrimary.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModWeaponEditSec.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModWeaponSubItem.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModWeaponSubSkill_New.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModWeaponSubSupport.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/LevelUpUi.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/LoadingBgUi.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/MissionResults.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/RoundEnd.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/RoundResult.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/RoundResultStat.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/Ruleset.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/ScoreScript.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/UiAttachmentColors.lua"Script.LoadLibrary"/Assets/mgo/ui/Script/UiWeaponAttachmentList.lua"Script.LoadLibrary"/Assets/mgo/level_asset/player/ParameterTables/PlayerTables.lua"Script.LoadLibrary"/Assets/mgo/level_asset/player/ParameterTables/AppealActions.lua"if TppSystemUtility.GetIsBeta()then
Script.LoadLibrary"/Assets/mgo/level_asset/player/ParameterTables/PlayerProgression_beta.lua"else
Script.LoadLibrary"/Assets/mgo/level_asset/player/ParameterTables/PlayerProgression.lua"end
Script.LoadLibrary"/Assets/mgo/level_asset/weapon/ParameterTables/ChimeraPartsPackageTable.lua"Script.LoadLibrary"/Assets/mgo/level_asset/weapon/ParameterTables/EquipParameterTables.lua"Script.LoadLibrary"/Assets/mgo/level_asset/config/EquipConfig.lua"Script.LoadLibrary"/Assets/mgo/level_asset/weapon/ParameterTables/WeaponParameterTables.lua"Script.LoadLibrary"/Assets/mgo/level_asset/config/RulesetConfig.lua"Script.LoadLibrary"/Assets/mgo/level_asset/config/SafeSpawnConfig.lua"Script.LoadLibrary"/Assets/mgo/level_asset/config/Soundtrack2Config.lua"Script.LoadLibrary"/Assets/mgo/level_asset/config/PresetRadioConfig.lua"Script.LoadLibrary"/Assets/mgo/level_asset/player/Stats/StatTables.lua"Script.LoadLibrary"/Assets/mgo/level_asset/config/PointOfInterestConfig.lua"Script.LoadLibrary"/Assets/mgo/level_asset/damage/ParameterTables/DamageParameterTables.lua"Script.LoadLibrary"/Assets/mgo/level_asset/weapon/ParameterTables/EquipMotionData.lua"Script.LoadLibrary"/Assets/mgo/level_asset/config/MgoWeaponParameters.lua"else
...
if i=="MGO"then
Script.LoadLibraryAsync"/Assets/mgo/script/tpplib/Tpp.lua"while Script.IsLoadingLibrary"/Assets/mgo/script/tpplib/Tpp.lua"do
t()end
else
Script.LoadLibraryAsync"/Assets/tpp/script/lib/Tpp.lua"while Script.IsLoadingLibrary"/Assets/tpp/script/lib/Tpp.lua"do
t()end
Script.LoadLibrary"/Assets/tpp/script/lib/TppDefine.lua"Script.LoadLibrary"/Assets/tpp/script/lib/TppVarInit.lua"Script.LoadLibrary"/Assets/tpp/script/lib/TppGVars.lua"end
if TppSystemUtility.GetCurrentGameMode()=="MGO"then
Script.LoadLibrary"/Assets/mgo/script/utils/SaveLoad.lua"Script.LoadLibrary"/Assets/mgo/script/lib/MgoMain.lua"Script.LoadLibrary"/Assets/mgo/level_asset/config/TppMissionList.lua"Script.LoadLibrary"/Assets/mgo/script/utils/Utils.lua"Script.LoadLibrary"/Assets/mgo/script/gear/RegisterGear.lua"Script.LoadLibrary"/Assets/mgo/level_asset/config/GearConfig.lua"Script.LoadLibrary"/Assets/mgo/script/player/PlayerResources.lua"Script.LoadLibrary"/Assets/mgo/script/player/PlayerDefaults.lua"Script.LoadLibrary"/Assets/mgo/script/Matchmaking.lua"else
...
t()if TppSystemUtility.GetCurrentGameMode()~="MGO"then
pcall(dofile,"/Assets/tpp/ui/Script/UiRegisterInfo.lua")end
...
math.randomseed(os.time())t()GrTools.SetSunLightReflectionMapShader"TPPSunLightReflectMap"GrTools.SetEnvironmentSpecularCubeTexture"/Assets/tpp/effect/gr_pic/gr_cub01_sm_SkySpecCommon.ftex"GrTools.SetEnableLocalReflection(true)GrTools.SetLightingColorScale(1.8)GrTools.SetLocalLightLodCameraBias(4)t()do
...
t()end
TppUI.FadeOut(TppUI.FADE_SPEED.FADE_MOMENT,nil,nil,{setMute=true})TppVarInit.InitializeOnStartTitle()TppVarInit.StartInitMission()TppUiCommand.SetLoadIndicatorVisible(false)if TppSystemUtility.GetCurrentGameMode()=="MGO"then
end