...
function o.GetAdjustedBlockSize(l)local c=0
if(l=="mission_block")then
c=4*1024
elseif(l=="SimpleStageBlockController")then
c=o.GetSimpleStageBlockSize()elseif(l=="TppSimpleMissionBlockControllerData0000")then
c=o.GetTppSimpleMissionBlock()elseif(l=="commonblock")then
c=o.GetCommonBlock()elseif(l=="dynamicblock")then
c=o.GetData(l)if Fox.GetPlatformName()=="XboxOne"then
c=c+512
end
else
c=o.GetData(l)end
...
function o.GetSimpleStageBlockSize()return 35061
end
function o.GetTppSimpleMissionBlock()local c=o.GetLocationString()if(a[c])~=nil then
...
function o.GetCommonBlock()local c=o.GetLocationString()if(a[c])~=nil then
local c=o.GetTppSimpleMissionBlock()local o=o.GetData"commonblock"return(c+o)end
return 0
end
return o