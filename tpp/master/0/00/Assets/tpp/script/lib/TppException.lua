...
local n=e.GetCurrentGameMode()if e.currentErrorPopupLangId and TppUiCommand.IsShowPopup(e.currentErrorPopupLangId)then
gvars.exc_processState=e.PROCESS_STATE.SHOW_DIALOG
local e=e.POPUP_CLOSE_CHECK_FUNC[gvars.exc_processingExecptionType]if e then
e()end
else
e.currentErrorPopupLangId=nil
local n=e.OnEndExceptionDialog[n]if not n then
