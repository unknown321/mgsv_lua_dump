local e={}e.IS_ONCE={false,true,true,true,true,false,false,false,true,true,false,false,false,false,false,false,false,false,false,false}e.UPDATE_ORDER={true,false,false,false,false,true,true,true,false,false,true,true,true,true,true,true,true,true,true,true}e.ANNOUNCE_LOG_TYPE={NONE=0,TIME=1,DISTANCE=2,NUMBER=3}e.SHOW_ANNOUNCE_LOG={e.ANNOUNCE_LOG_TYPE.NONE,e.ANNOUNCE_LOG_TYPE.TIME,e.ANNOUNCE_LOG_TYPE.TIME,e.ANNOUNCE_LOG_TYPE.TIME,e.ANNOUNCE_LOG_TYPE.TIME,e.ANNOUNCE_LOG_TYPE.DISTANCE,e.ANNOUNCE_LOG_TYPE.NONE,e.ANNOUNCE_LOG_TYPE.DISTANCE,e.ANNOUNCE_LOG_TYPE.TIME,e.ANNOUNCE_LOG_TYPE.TIME,e.ANNOUNCE_LOG_TYPE.NONE,e.ANNOUNCE_LOG_TYPE.NONE,e.ANNOUNCE_LOG_TYPE.NONE,e.ANNOUNCE_LOG_TYPE.TIME,e.ANNOUNCE_LOG_TYPE.TIME,e.ANNOUNCE_LOG_TYPE.TIME,e.ANNOUNCE_LOG_TYPE.TIME,e.ANNOUNCE_LOG_TYPE.TIME,e.ANNOUNCE_LOG_TYPE.TIME,e.ANNOUNCE_LOG_TYPE.TIME}e.OPEN_CONDITION={true,10043,10036,10033,10041,10044,10054,10052,10086,function()if gvars.rnk_isOpen[TppDefine.RANKING_ENUM.XRocketArmNeutralizeTime]then
return true
end
