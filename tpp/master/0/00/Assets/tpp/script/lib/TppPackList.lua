...
function e.AddLocationCommonScriptPack(i)local n=TppLocation.GetLocationName()if n=="afgh"then
...
local n=TppDefine.MISSION_ENUM[tostring(i)]if n then
e.AddMissionPack"/Assets/tpp/pack/mission2/common/online_challenge.fpk"end
end
...
function e.AddFOBLayoutPack(n)local s,i=e.GetMissionTypeAndMissionName(n)if n==50050 then
end
if(n==50050)or(n==10115)then
local i="/Assets/tpp/pack/mission2/"..(s..("/"..(i..("/"..(i..string.format("_area_ly%03d",vars.mbLayoutCode))))))local a=i..".fpk"local s=vars.mbClusterId
if(n==10115)then
s=TppDefine.CLUSTER_DEFINE.Develop
end
local n=i..(string.format("_cl%02d",s)..".fpk")e.AddMissionPack(a)e.AddMissionPack(n)elseif n==30050 then
local n="/Assets/tpp/pack/mission2/"..(s..("/"..(i..("/"..(i..string.format("_ly%03d",vars.mbLayoutCode))))))local n=n..".fpk"e.AddMissionPack(n)end
end
...
function e.GetLocationNameFormMissionCode(s)local e
