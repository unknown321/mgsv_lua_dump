...
-- 	items = {TppEquip.EQP_WP_EX_hg_000_G04,TppEquip.EQP_WP_40127,TppEquip.EQP_WP_Quiet_sr_030,TppEquip.EQP_WP_Wood_ar_010,TppEquip.EQP_WP_6040a, TppEquip.EQP_WP_EX_sr_000, TppEquip.EQP_WP_8013b}
-- 	-- TppUiCommand.AnnounceLogView(string.format('#%s',tostring(counter) ))
-- 	-- TppUiCommand.AnnounceLogView('Gift from KojiPro')
-- 	-- TppUiCommand.AnnounceLogView(string.format(':%s',items[counter] ))
-- 	-- for k,v in pairs(items) do
-- 		-- TppUiCommand.AnnounceLogView(v)
-- 		TppEquip.RequestLoadToEquipMissionBlock{TppEquip.EQP_WP_EX_hg_000_G04,TppEquip.EQP_WP_Quiet_sr_030,TppEquip.EQP_WP_40203,}
		Player.ChangeEquip{
			equipId = TppEquip.EQP_WP_EX_hg_013,
			stock = 30,
			stockSub = 0,
			ammo = 1,
			ammoSub = 0,
...
-- 		Player.ChangeEquip{
-- 			equipId = TppEquip.EQP_WP_Quiet_sr_030,
-- 			stock = 30,
-- 			stockSub = 0,
-- 			ammo = 1,
-- 			ammoSub = 0,
		...
		GameObject = {
			...
			{	
				...
				func = function( cpId, phase )
					TppUiCommand.AnnounceLogView('PHASE CHANGED')
			...
			{	
				...
				func = function( gameObjectId, attackId, attakerId )
					TppUiCommand.AnnounceLogView('DAMAGE')
