...
s[30050]=function(p)TppPackList.AddLocationCommonScriptPack(p)TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.HELICOPTER)TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.MTBS_MISSION_AREA)do
...
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.DD_SOLDIER_WAIT)TppPackList.AddMissionPack"/Assets/tpp/pack/mission2/free/f30050/f30050.fpk"TppPackList.AddFOBLayoutPack(p)gvars.f30050_missionPackIndex=0
end
end
