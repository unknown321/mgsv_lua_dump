...
function o.SetUpCpEmblemTag(o,r)mvars.emb_cpAnihilateEmblemTag=mvars.emb_cpAnihilateEmblemTag or{}local o=e[o]if o then
...
function o.AcquireByPlayStyle(r)local r=d[r]if r then
...
if a then
local o=TppUiCommand.GetEmblemLangId(o)local r=TppUI.EMBLEM_ANNOUNCE_LOG_TYPE[r]TppUI.ShowAnnounceLog(r,o)end
return true
end
function o.Remove(o)if not TppUiCommand.HasEmblemTexture(o)then
return
end
TppUiCommand.RemoveEmblemTexture(o)return true
end
return o