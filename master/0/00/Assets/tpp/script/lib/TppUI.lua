...
function e.FadeIn(t,i,o,n)local i=a(i)if n then
...
TppSoundDaemon.ResetMute"Outro"p(t,i,o)e.EnableGameStatusOnFadeInStart()end
...
function e.FadeOut(o,p,s,n)local i,t
if Tpp.IsTypeTable(n)then
i=n.setMute
t=n.exceptGameStatus
end
local n=a(p)e.DisableGameStatusOnFade(t)if i then
...
_(o,n,s)end
function e.ShowAnnounceLog(a,t,o,i,n)if gvars.ini_isTitleMode then
return
end
...
function e.ShowColorAnnounceLog(i,t,a,n)if gvars.ini_isTitleMode then
return
end
local e=e.ANNOUNCE_LOG_TYPE[i]if e then
if n then
TppUiCommand.AnnounceLogDelayTime(n)end
TppUiCommand.AnnounceLogViewLangId(e,t,a,0,0,true)end
end
...
function e.ShowColorJoinAnnounceLog(n,t,o,a,i)if gvars.ini_isTitleMode then
return
end
local n=e.ANNOUNCE_LOG_TYPE[n]local e=e.ANNOUNCE_LOG_TYPE[t]if n and e then
if i then
TppUiCommand.AnnounceLogDelayTime(i)end
TppUiCommand.AnnounceLogViewJoinLangId(n,e,o,a,0,0,true)end
end
...
function e.EnableMissionPhoto(e,i,n,t,a)TppUiCommand.EnableMissionPhotoId(e)if TppUiCommand.IsMissionPhotoIdEnable(e)then
if i or n then
if i==nil then
i=false
end
...
if a then
local n=r(a)TppUiCommand.SetMissionPhotoRadioGroupName(e,n)end
end
end
...
local s=e.GetTaskCompletedNumber(n)e.SetTaskLastCompleted(i,true)local t=e.GetTaskCompletedNumber(n)local o=e.GetMaxMissionTask(n)if o==nil then
return
end
if a then
if t>s then
e.ShowAnnounceLog("task_complete",t,o)end
end
TppMission.SetPlayRecordClearInfo()TppChallengeTask.RequestUpdate"MISSION_TASK"e.UpdateOnlineChallengeTask{detectType=(34+i),diff=1}if e.IsAllTaskCompleted(n)then
...
function e.UpdateOnlineChallengeTask(e)if OnlineChallengeTask then
OnlineChallengeTask.Update(e)end
end
...
TppUiCommand.SetButtonGuideDispTime(i)if not o then
if(s==true)then
...
local n,e,i=e[1],e[2],e[3]TppUiCommand.RegistCpNameBaseLangId(n,e,i)end
end
...
TppUiCommand.SetMissionNameStatus{missionId=10260,type="REPLAY"}if TppStory.CanPlayReunionQuietMission()then
TppUiCommand.SetMissionNameStatus{missionId=10050,type="REUNION"}else
TppUiCommand.SetMissionNameStatus{missionId=10050,type="REPLAY"}end
else
...
function e.OnMessage(o,t,p,s,i,a,n)Tpp.DoMessage(e.messageExecTable,TppMission.CheckMessageOption,o,t,p,s,i,a,n)end
function e.OnChangeSVars(n,e)if FobUI then
FobUI.OnChangeSVars(n,e)end
end
function e.DisableGameStatusOnFade(e)local n={S_DISABLE_NPC=false}if i(e)then
for e,i in pairs(e)do
n[e]=i
end
end
Tpp.SetGameStatus{target="all",enable=false,except=n,scriptName="TppUI.lua"}end
