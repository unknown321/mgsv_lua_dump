...
function a.CanUseArmorType(n,e)local t={PF_A=TppDefine.AFR_ARMOR.TYPE_CFA,PF_B=TppDefine.AFR_ARMOR.TYPE_ZRS,PF_C=TppDefine.AFR_ARMOR.TYPE_RC}local e=t[e]if e==nil then
return true
end
...
function a.SetHostageFaceTable(o)local s=a.GetHostageCountAtMissionId(o)local t=a.GetHostageLangAtMissionId(o)local c=0
if s>0 then
local n={}if t==p then
...
local _=a.GetHostageIsFaceModelOverlap(o)local r=a.GetHostageIgnoreFaceList(o)local T=a.GetHostageFaceModelCount(o)local r=TppSoldierFace.CreateFaceTable{race=n,needCount=s,maxUsedFovaCount=T,faceModelOverlap=_,ignoreFaceList=r,raceHalfMode=c}if r~=nil then
local d={}local t={}local n=#r
local a=e
if s<=n then
a=1
end
...
function a.GetFaceGroupTableAtGroupType(e)local t=TppEnemyFaceGroup.GetFaceGroupTable(e)local e={}local a=EnemyFova.MAX_REALIZED_COUNT
...
n[10045]=function(e,a)local e=o(n)e:case("Afghan",a)local e={}for a=0,9 do
...
n[11090]=n[10090]n[10091]=function(e,a)local e=o(n)e:case("Africa",a)local e={}for a=0,9 do
table.insert(e,a)end
for a=20,39 do
table.insert(e,a)end
for a=50,81 do
...
local t=e[d]local e=e[a]local a={{TppEnemyFaceId.pfs_balaclava,2,2,0},{t,1,1,0},{e,1,1,0}}TppSoldierFace.OverwriteMissionFovaData{face=a,additionalMode=true}local d=265
local a=266
TppSoldierFace.SetSpecialFovaId{face={t,e},body={d,a}}local e={{d,1},{a,1}}TppSoldierFace.OverwriteMissionFovaData{body=e,additionalMode=true}end
n[11091]=n[10091]n[10080]=function(a,t)local a=o(n)a:case("Africa",t)if TppPackList.IsMissionPackLabel"afterPumpStopDemo"then
else
...
TppSoldierFace.SetPoolTable{face=a,randomSeed=t}TppSoldierFace.SetSoldierNoFaceResourceMode(true)TppSoldierFace.SetUseFaceIdListMode{enabled=true,staffCheck=true}local e={{140,e},{141,e},{TppEnemyBodyId.dds5_main0_v00,e}}TppSoldierFace.SetBodyFovaUserType{hostage={TppEnemyBodyId.dds5_main0_v00}}TppHostage2.SetDefaultBodyFovaId{parts=y,bodyId=TppEnemyBodyId.dds5_main0_v00}TppSoldierFace.OverwriteMissionFovaData{body=e}end
n[11115]=n[10115]n[10130]=function(e,a)local e=o(n)e:case("Africa",a)TppSoldierFace.SetUseZombieFova{enabled=true}end
...
function n.Africa(n,p)local o=0
if TppSoldierFace.IsMoreVariationMode~=nil then
o=TppSoldierFace.IsMoreVariationMode()end
local t=30
local n=gvars.solface_groupNumber
local d=(n%t)*2
local l=TppEnemyFaceGroupId.AFRICA_GRP000_B+(d)local i=a.GetFaceGroupTableAtGroupType(l)TppSoldierFace.OverwriteMissionFovaData{face=i}if o>0 then
for e=1,2 do
n=n+2
local e=(n%t)*2
...
d=(n%t)*2
l=TppEnemyFaceGroupId.AFRICA_GRP000_W+(d)local d=a.GetFaceGroupTableAtGroupType(l)TppSoldierFace.OverwriteMissionFovaData{face=d}if o>0 then
for e=1,2 do
n=n+2
local e=(n%t)*2
...
local c={}local o={}local p={}local t={}local l=0
local d=0
local i=0
local s=0
local r=0
...
local _=32
local f=0
function a.InitializeUniqueSetting()c={}o={}p={}t={}l=0
d=0
i=0
s=0
r=0
...
function a.GetStaffIdForDD(e,n)local a=f
if e==10081 then
...
function a.GetFaceId_s10081()return i
end
function a.GetFaceId_s10091_0()return s
end
function a.GetFaceId_s10091_1()return r
end
...
function a.GetFaceIdAndFlag(n,e)local t=EnemyFova.NOT_USED_FOVA_VALUE
if e=="female"then
if n=="hostage"then
...
function a.RegisterUniqueSetting(d,i,l,n)local e=EnemyFova.NOT_USED_FOVA_VALUE
...
table.insert(c,{name=i,faceId=a,bodyId=n,flag=l})do
local p=1
local n=2
local t=3
local l=4
...
function a.ApplyUniqueSetting()local t=GameObject.NULL_ID
local e=EnemyFova.NOT_USED_FOVA_VALUE
if gvars.ene_fovaUniqueTargetIds[0]==t then
local e=0
for n,a in ipairs(c)do
local n=GameObject.GetGameObjectId(a.name)if n~=t then
...
local e=gvars.ene_fovaUniqueTargetIds[n]if e==t then
break
end
local t={id="ChangeFova",faceId=gvars.ene_fovaUniqueFaceIds[n],bodyId=gvars.ene_fovaUniqueBodyIds[n]}GameObject.SendCommand(e,t)local t=0
if gvars.ene_fovaUniqueFlags then
t=gvars.ene_fovaUniqueFlags[n]end
if d(t,T)~=0 then
local o=vars.missionCode
local n=d(t,m)local a=a.GetStaffIdForDD(o,n)if a~=f then
local a={id="SetStaffId",staffId=a}GameObject.SendCommand(e,a)end
local a={id="SetHostage2Flag",flag="dd",on=true}GameObject.SendCommand(e,a)elseif d(t,_)~=0 then
...
function a.GetUavSetting()local o=TppMotherBaseManagement.GetMbsUavLevel{}local i=TppMotherBaseManagement.GetMbsUavSmokeGrenadeLevel{}local _=TppMotherBaseManagement.GetMbsUavSleepingGusGrenadeLevel{}local n=TppMotherBaseManagement.GetMbsClusterSecuritySoldierEquipGrade{}local T=TppMotherBaseManagement.GetMbsClusterSecurityIsNoKillMode()local l=TppUav.DEVELOP_LEVEL_LMG_0
local d=false
local s=false
local a=100
local e=a
...
function a.GetUavCombatGradeAndEmpLevel(t,l,a,o)if t<9 then
return nil,0
end
local d={[9]={4,2},[10]={5,3},[11]={6,4}}local n,e
if l then
e=2
n=o
else
