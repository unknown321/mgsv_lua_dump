...
function e.IsBroken(e)if not a(e)then
return
end
local n,i
n=e.gimmickId
...
local e=mvars.gim_identifierParamTable[n]if Gimmick.IsBrokenGimmick and e then
if i then
...
e.EnableCollectionTable(t,n)end
do
local t={"col_develop_Shield0002"}local n
local i=TppStory.GetCurrentStorySequence()if i>=TppDefine.STORY_SEQUENCE.CLEARD_FIND_THE_SECRET_WEAPON then
n=true
else
n=false
...
local e=e.MissionCollectionTable[n]for t,n in pairs(e)do
...
if e then
TppCollection.RepopCountOperation("SetAt",n,0)end
end
end
end
function e.OnReload()e.messageExecTable=Tpp.MakeMessageExecTable(e.Messages())end
function e.OnMessage(a,n,i,t,o,r,l)Tpp.DoMessage(e.messageExecTable,TppMission.CheckMessageOption,a,n,i,t,o,r,l)end
...
mvars.gim_identifierTable={}for o,e in pairs(e)do
local n=e.type
local t=e.locatorName
local a=e.dataSetName
mvars.gim_identifierTable[n]=mvars.gim_identifierTable[n]or{}local e=mvars.gim_identifierTable[n]e[i(t)]=e[i(t)]or{}local e=e[i(t)]e[Fox.PathFileNameCode32(a)]=o
end
end
...
function e.SetUpCheckBrokenAndBreakConnectTable(n)mvars.gim_checkBrokenAndBreakConnectTable={}for n,i in pairs(n)do
e._SetUpCheckBrokenAndBreakConnectTable(n,i)end
end
function e._SetUpCheckBrokenAndBreakConnectTable(e,i)if not mvars.gim_identifierParamTable[e]then
return
end
...
mvars.gim_checkBrokenAndBreakConnectTable[n]={checkBrokenGimmickId=e,breakGimmickId=t}end
...
function e.SetUpConnectPowerCutTable(e)mvars.gim_connectPowerCutAreaTable={}mvars.gim_connectPowerCutCpTable={}for n,e in pairs(e)do
local t=e.powerCutAreaName
local e=e.cpName
mvars.gim_connectPowerCutAreaTable[n]=t
if e then
local i=l(e)if i~=o then
mvars.gim_connectPowerCutCpTable[n]=i
local i={type="TppCommandPost2"}local n=mvars.gim_identifierParamTable[n]local e={id="SetPowerSourceGimmick",cpName=e,gimmicks=n,areaName=t}GameObject.SendCommand(i,e)end
end
end
end
function e.SetUpConnectVisibilityTable(e)mvars.gim_connectVisibilityTable={}for e,n in pairs(e)do
...
mvars.gim_gimmickIdToCpTable=mvars.gim_gimmickIdToCpTable or{}local r={type="TppCommandPost2"}for n,e in pairs(e)do
local a={}for e,t in ipairs(e)do
local e=mvars.gim_identifierParamTable[t]if e then
table.insert(a,e)end
local e=l(n)if e~=o then
mvars.gim_gimmickIdToCpTable[i(t)]=e
end
end
local i=e.isCommunicateBase
local e=e.groupName
local e={id="SetCommunicateGimmick",cpName=n,isCommunicateBase=i,gimmicks=a,groupName=e}GameObject.SendCommand(r,e)end
end
function e.BreakGimmick(a,n,t,i)local n=e.GetGimmickID(a,n,t)if not n then
return
end
...
function e.GetGimmickID(e,n,i)local t=m(e)local e=mvars.gim_identifierTable
if not e then
return
end
...
function e.ShowAnnounceLog(n)local i=mvars.gim_identifierParamTable[n].gimmickType
if not i then
return
end
local i=s[i]if i then
TppUI.ShowAnnounceLog(i)end
e._ShowCommCutOffAnnounceLog(n)end
...
function e.SwitchGimmick(n,i,t,o)local n=e.GetGimmickID(n,i,t)if not n then
return
end
local i=false
if(o==0)then
...
function e.CheckQuestAllTarget(n,a,l)local t=TppDefine.QUEST_CLEAR_TYPE.NONE
local r=l or false
local l=false
...
function e.SetQuestSootingTargetInvincible(n)for i,e in pairs(mvars.gim_questTargetList)do
