...
WeatherManager.RequestWeather{priority=WeatherManager.REQUEST_PRIORITY_NORMAL,userId=s,weatherType=r,interpTime=a}if t~=nil then
WeatherManager.RequestWeather{priority=WeatherManager.REQUEST_PRIORITY_EXTRA,userId=s,weatherType=t,interpTime=a}end
...
function e.RestoreFromSVars()local e=TppMission.IsFOBMission(vars.missionCode)if e then
else
local e=vars.requestWeatherType[WeatherManager.REQUEST_PRIORITY_NORMAL]if o[e]then
