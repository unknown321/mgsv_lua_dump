...
function e.DoFuncByFultonTypeSwitch(e,n,r,a,o,t,M,_,E,i,u,s,p,T,S,d,l,c)if Tpp.IsSoldier(e)then
...
return d(e,n,r,a,nil,t)elseif Tpp.IsBossQuiet(e)then
return l(e,n,r,a,o,t)elseif Tpp.IsParasiteSquad(e)then
return c(e,n,r,a,nil,t)else
...
PlayRecord.RegistPlayRecord"SOLDIER_RESCUE"Tpp.IncrementPlayData"totalRescueCount"TppUI.UpdateOnlineChallengeTask{detectType=2,diff=1}end
...
TppUI.UpdateOnlineChallengeTask{detectType=3,diff=1}end
e.AddTempStaffFulton{staffId=n,gameObjectId=t,tempStaffStatus=M,fultonedPlayer=o}end
function e.OnFultonVehicle(t,r,r,a,r,n)if mvars.trm_isSkipAddResourceToTempBuffer then
return
end
e.AddTempResource(a,nil,n)if OnlineChallengeTask then
OnlineChallengeTask.UpdateOnFultonVehicle(t)end
end
function e.OnFultonContainer(r,t,n,M,M,a,o)if mvars.trm_isSkipAddResourceToTempBuffer then
return
end
...
local e=TppGimmick.GetGimmickID(r,t,n)if not e then
...
e.AddTempResource(t)TppUI.UpdateOnlineChallengeTask{detectType=8,diff=1}end
